...
## Development environment and release process
 ...
 - create virtualenv with Flask and Transcript Hero installed into it (latter is installed in
...
install it (`pip install transcript_hero.tar.gz`), ensure that configuration file exists and
